...
### Замечания
- Обязательно использование MobX и typescript.
- Желательно использование MaterialUI
- Во время загрузки книг стоит показать какой-то лоадер
...
- Верстка может быть самая простая, основное разрешение экрана - 1920х1080. Адаптивность под мобильную версию - не нужна.
